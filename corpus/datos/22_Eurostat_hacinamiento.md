# Tasa de hacinamiento en la vivienda: España y la UE

| | |
|---|---|
| **Qué mide** | Porcentaje de población que vive en un hogar sin habitaciones suficientes para su tamaño y composición. |
| **Quién lo publica** | Eurostat (Oficina Estadística de la Unión Europea) |
| **Operación estadística** | ilc_lvho05a — conjunto de datos de Eurostat |
| **Periodicidad** | Anual |
...
```
https://ec.europa.eu/eurostat/api/dissemination/statistics/1.0/data/ilc_lvho05a?format=JSON&geo=ES&geo=EU27_2020&lastTimePeriod=6
```
