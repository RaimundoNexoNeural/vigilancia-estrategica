# Viviviendas con ejecución hipotecaria iniciada según titular de la vivienda por comunidad autónoma

| | |
|---|---|
| **Qué mide** | Viviviendas con ejecución hipotecaria iniciada según titular de la vivienda por comunidad autónoma. Serie publicada dentro de la operación «Estadística sobre Ejecuciones Hipotecarias». |
| **Quién lo publica** | Instituto Nacional de Estadística (INE) |
| **Operación estadística** | EH — Estadística sobre Ejecuciones Hipotecarias |
| **Periodicidad** | Anual |
| **Periodo que cubre este fichero** | 2017-12-31 a 2024-12-31 |
...
```
https://servicios.ine.es/wstempus/js/ES/DATOS_TABLA/10741?nult=8
```
