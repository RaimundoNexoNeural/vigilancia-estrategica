# Compraventa de viviendas según régimen y estado

| | |
|---|---|
| **Qué mide** | Compraventa de viviendas según régimen y estado. Serie publicada dentro de la operación «Estadística de Transmisión de Derechos de la Propiedad». |
...
```
https://servicios.ine.es/wstempus/js/ES/DATOS_TABLA/6150?nult=12
```
