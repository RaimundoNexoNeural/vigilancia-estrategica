# Índice de precios de la vivienda, anual: España y la UE

| | |
|---|---|
| **Qué mide** | La misma serie de precios de vivienda en medias anuales, que es la que sirve para comparar años completos. |
| **Quién lo publica** | Eurostat (Oficina Estadística de la Unión Europea) |
| **Operación estadística** | prc_hpi_a — conjunto de datos de Eurostat |
| **Periodicidad** | Anual |
| **Periodo que cubre este fichero** | 2018 a 2025 |
...
```
https://ec.europa.eu/eurostat/api/dissemination/statistics/1.0/data/prc_hpi_a?format=JSON&geo=ES&geo=EU27_2020&lastTimePeriod=8
```
