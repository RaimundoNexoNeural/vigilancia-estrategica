# Índices de precios de materiales generales (base diciembre 2011)

| | |
|---|---|
| **Qué mide** | Índices de precios de materiales generales (base diciembre 2011). Serie publicada dentro de la operación «Índices de Precios de Materiales y Energía e Índices Nacionales de la Mano de Obra». |
...
```
https://servicios.ine.es/wstempus/js/ES/DATOS_TABLA/77209?nult=12
```
