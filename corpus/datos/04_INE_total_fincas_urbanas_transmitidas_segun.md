...
| | |
|---|---|
| **Qué mide** | Total fincas urbanas transmitidas según título de adquisición. Serie publicada dentro de la operación «Estadística de Transmisión de Derechos de la Propiedad». |
...
```
https://servicios.ine.es/wstempus/js/ES/DATOS_TABLA/6148?nult=12
```
