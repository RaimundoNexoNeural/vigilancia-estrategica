# Índice de precios de la vivienda, trimestral: España y la UE

| | |
|---|---|
| **Qué mide** | Índice de precios de la vivienda y su variación, para España y para el conjunto de la UE-27, en serie trimestral. |
| **Quién lo publica** | Eurostat (Oficina Estadística de la Unión Europea) |
| **Operación estadística** | prc_hpi_q — conjunto de datos de Eurostat |
| **Periodicidad** | Trimestral |
| **Periodo que cubre este fichero** | 2024-Q2 a 2026-Q1 |
...
```
https://ec.europa.eu/eurostat/api/dissemination/statistics/1.0/data/prc_hpi_q?format=JSON&geo=ES&geo=EU27_2020&lastTimePeriod=8
```
