# Índices nacionales: general y por divisiones

| | |
|---|---|
| **Qué mide** | Índices nacionales: general y por divisiones. Serie publicada dentro de la operación «Índice de Producción de la Construcción». |
...
```
https://servicios.ine.es/wstempus/js/ES/DATOS_TABLA/75486?nult=12
```
