...
| | |
|---|---|
| **Qué mide** | Porcentaje de viviendas turísticas sobre el total de viviendas censadas. Total nacional, comunidades autónomas y provincias. Serie publicada dentro de la operación «Viviendas turísticas en España». |
| **Quién lo publica** | Instituto Nacional de Estadística (INE) |
| **Operación estadística** | VTE — Viviendas turísticas en España |
| **Periodicidad** | Mensual |
| **Periodo que cubre este fichero** | 2021-01-31 a 2026-04-30 |
...
```
https://servicios.ine.es/wstempus/js/ES/DATOS_TABLA/39365?nult=12
```
