# Índice nacional de la mano de obra en construcción (base julio 1980)

| | |
|---|---|
| **Qué mide** | Índice nacional de la mano de obra en construcción (base julio 1980). Serie publicada dentro de la operación «Índices de Precios de Materiales y Energía e Índices Nacionales de la Mano de Obra». |
| **Quién lo publica** | Instituto Nacional de Estadística (INE) |
| **Operación estadística** | IMM — Índices de Precios de Materiales y Energía e Índices Nacionales de la Mano de Obra |
| **Periodicidad** | Mensual |
| **Periodo que cubre este fichero** | 2025-03-31 a 2026-02-28 |
...
```
https://servicios.ine.es/wstempus/js/ES/DATOS_TABLA/8377?nult=12
```
