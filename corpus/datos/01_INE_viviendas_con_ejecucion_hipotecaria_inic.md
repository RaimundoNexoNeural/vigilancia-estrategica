# Viviendas con ejecución hipotecaria iniciada según estado de la vivienda por comunidad autónoma

| | |
|---|---|
| **Qué mide** | Viviendas con ejecución hipotecaria iniciada según estado de la vivienda por comunidad autónoma. Serie publicada dentro de la operación «Estadística sobre Ejecuciones Hipotecarias». |
...
```
https://servicios.ine.es/wstempus/js/ES/DATOS_TABLA/10740?nult=8
```
