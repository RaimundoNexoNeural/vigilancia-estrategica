...
| | |
|---|---|
| **Qué mide** | Total fincas transmitidas según naturaleza de la finca. Serie publicada dentro de la operación «Estadística de Transmisión de Derechos de la Propiedad». |
...
```
https://servicios.ine.es/wstempus/js/ES/DATOS_TABLA/6146?nult=12
```
