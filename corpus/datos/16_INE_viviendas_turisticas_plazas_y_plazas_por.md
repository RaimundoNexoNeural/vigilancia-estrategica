...
| | |
|---|---|
| **Qué mide** | Viviendas turísticas, plazas y plazas por vivienda turística. Total nacional, comunidades autónomas y provincias. Serie publicada dentro de la operación «Viviendas turísticas en España». |
...
```
https://servicios.ine.es/wstempus/js/ES/DATOS_TABLA/39364?nult=12
```
